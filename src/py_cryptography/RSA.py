...
class RSA:
        def __init__(self,outputDir = os.path.dirname(os.path.realpath(__file__))):
        ...
        def RSA_encode(self,message,keys):
        ...
        def RSA_decode(self,message,keys):
...
class RSA_tests(unittest.TestCase):
	...
	def test_2(self):
		...
		RSA_encode(parse_txt('test_essay.txt'),'public.b')
		
	def test_3(self):
		print('Essay decode test running... ')
		RSA_decode('message.b','private.b')
...
'''	
	...
	def test_5(self):
		print('Shakespeare decode test running... ')
		RSA_decode('message.b','private.b')
'''
